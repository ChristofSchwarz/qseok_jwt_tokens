// npm install ws enigma.js https
...
const debugInfo = false;  // show https options and body
...
function qlikApi(moreOptions, requestBody, returnMsg){    
    ...
    return new Promise(function(resolve, reject) {     
        ...
        if (debugInfo) console.log(options.method + ' ' + options.path + ' ' + requestBody);
...
.then(function(result){
    ...
    console.log('app finished reload.');
    return appHandle.doSave();
}).then(function(ret){
    console.log('App saved. Done.');
    session.close();
}).catch(function(err){
